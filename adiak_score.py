def calculate_adiak_grade():
    ...
    presentation = float(input("Presentation balını daxil edin (0-15): "))
    
    # Aktivlik birbaşa 20 bal
    participation = float(input("Aktivlik (Participation) balını daxil edin (0-20): "))
    ...
    pre_exam_total = presentation + participation + midterm_contribution
    print(f"-> İmtahana qədər toplanan cəmi bal (Pre-exam): {pre_exam_total} / 55")
    ...
    print(f"-> Final imtahanından gələn bal: {final_contribution} / 45")
